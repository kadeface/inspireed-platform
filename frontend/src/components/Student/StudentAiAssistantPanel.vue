<template>
  <div class="flex h-full flex-col">
    ...
    <main class="flex-1 overflow-y-auto px-5 py-4 bg-[#F7F8FC]">
      <!-- 标签页导航 -->
      ...
      <div v-show="activeTab === 'resources'" class="space-y-4">
        <section
          ...
          :key="category.name"
          class="rounded-2xl border border-[#D9DFF5] bg-white p-4"
        >
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <a
              ...
              class="group flex items-center gap-2 rounded-lg border border-transparent bg-[#F7F8FC] px-3 py-2 text-xs text-[#4C568E] transition hover:border-[#4C6EF5] hover:bg-[#EFF2FF] hover:text-[#4C6EF5]"
            >
