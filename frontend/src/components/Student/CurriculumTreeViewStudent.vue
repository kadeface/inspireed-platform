<template>
  <div class="curriculum-tree-view-student">
    <!-- 加载状态 -->
    ...
    <div v-else class="tree-container">
      ...
      <div class="stats-summary">
        <div class="stat-item">
          <span class="stat-label">可学学科</span>
        ...
        <div class="stat-item">
          <span class="stat-label">学习内容</span>
        ...
        >
          ...
          >
            <div class="subject-info">
              ...
              <span class="subject-emoji">{{ getSubjectEmoji(subject.code) }}</span>
              <h3 class="subject-name">{{ subject.name }}</h3>
              <span class="lesson-badge" v-if="subject.lesson_count > 0">
                {{ subject.lesson_count }} 个课程
              </span>
            </div>
          </div>
                    ...
                    >
                      <div class="course-info">
                        ...
                        <span class="lesson-badge" v-if="course.lesson_count > 0">
                          {{ course.lesson_count }} 个课程
                        </span>
                      </div>
                      <button
                        v-if="selectedCourse?.id === course.id && course.lesson_count > 0"
      ...
      <div v-else class="empty-state">
        ...
        <p class="text-gray-500">暂无可学习的课程</p>
        <p class="text-sm text-gray-400 mt-2">请等待老师发布课程</p>
      </div>
    </div>
      ...
      <div v-if="showCourseDetails && courseDetails" class="course-details-sidebar">
        ...
        <div class="sidebar-content">
          ...
          <div class="course-meta">
            ...
            <div class="meta-item">
              <span class="meta-label">章节总数</span>
              <span class="meta-value">{{ courseDetails.total_chapters }}</span>
            </div>
            <div class="meta-item">
              <span class="meta-label">课程内容</span>
          ...
          <div class="chapters-section">
            <h4 class="section-title">📖 学习目录</h4>
            ...
            <div v-else class="empty-chapters">
              <p class="text-gray-500 text-sm">该课程暂无学习内容</p>
            </div>
          </div>
        </div>
      </div>
...
import ChapterTreeNodeStudent from './ChapterTreeNodeStudent.vue'
...
function getSubjectEmoji(code: string): string {
  return subjectEmojiMap[code] || '📚'
}
