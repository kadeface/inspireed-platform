        ...
        >
          ...
          <div class="grid gap-6 border-b border-gray-200 px-6 py-5 lg:grid-cols-[2fr,3fr]">
            <section class="space-y-4">
              ...
              <!-- 智能体选择（课程设计 Skill 主题下隐藏，避免与 Skill 手册冲突） -->
              <div v-if="selectedTopic !== 'course_design'" class="space-y-3">
              ...
              <template v-if="selectedTopic !== 'course_design'">
                <!-- 教案优化功能（仅在教案共创主题显示） -->
            ...
            >
              <div
                v-if="selectedTopic === 'course_design'"
                class="flex-1 overflow-y-auto rounded-2xl bg-white/90 backdrop-blur-sm p-5 shadow-inner border border-gray-100"
              >
                <CourseDesignSkillPanel />
              </div>
              <div
                v-else-if="response"
...
import CourseDesignSkillPanel from '@/components/Teacher/CourseDesignSkillPanel.vue'
...
const topicOptions: Array<{ label: string; value: TeacherAssistantTopic }> = [
  { label: '课程设计 Skill', value: 'course_design' },
