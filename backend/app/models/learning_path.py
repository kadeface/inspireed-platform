...
class LearningPath(Base):
    ...
    difficulty_level = Column(SQLEnum(DifficultyLevel), default=DifficultyLevel.BEGINNER, nullable=False, comment="难度等级")
    ...
    path_lessons = relationship("LearningPathLesson", back_populates="learning_path", cascade="all, delete-orphan")
...
class LearningPathLesson(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    learning_path_id = Column(Integer, ForeignKey("learning_paths.id"), nullable=False, comment="学习路径ID")
