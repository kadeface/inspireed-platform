...
async def download_import_template(
    ...
    templates = {
        ...
        ImportStrategyType.STUDENT_ACCOUNT: {
            ...
            "headers_district": ["学校名称*", "学校代码", "年级级别*", "班级编号*", "学籍号*", "姓名*", "用户名", "邮箱", "手机号", "性别", "密码"],
            "examples_district": ["第一中学", "101", "10", "1001", "2024100001", "张三", "2024100001", "2024100001@inspireed.com", "13800138000", "男", "123456"],
            "headers_school": ["年级级别*", "班级编号*", "学籍号*", "姓名*", "用户名", "邮箱", "手机号", "性别", "密码"],
            "examples_school": ["10", "1001", "2024100001", "张三", "2024100001", "2024100001@inspireed.com", "13800138000", "男", "123456"],
            "descriptions": ["必填", "可选", "必填", "必填", "必填", "必填", "可选", "可选", "可选", "可选", "可选（留空则默认123456）"],
        },
    ...
    if strategy_type == ImportStrategyType.STUDENT_ACCOUNT:
        ...
        additional_examples = [
            ["第一中学", "101", "10", "1001", "2024100002", "李四", "2024100002", "2024100002@inspireed.com", "13800138001", "女", "123456"] if not is_school_admin else ["10", "1001", "2024100002", "李四", "2024100002", "2024100002@inspireed.com", "13800138001", "女", "123456"],
            ["第一中学", "101", "10", "1002", "2024100003", "王五", "2024100003", "2024100003@inspireed.com", "13800138002", "男", "123456"] if not is_school_admin else ["10", "1002", "2024100003", "王五", "2024100003", "2024100003@inspireed.com", "13800138002", "男", "123456"],
        ]
