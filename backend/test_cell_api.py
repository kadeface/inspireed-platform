...
TEST_CELL_DATA = {
    ...
    "cell_type": "qa",
    "title": "测试QA Cell",
    "content": {"question": "", "answer": "", "isAIAnswer": False},
    "config": {},
    "order": 0,
    "editable": True,
}
...
async def test_cell_api():
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            update_data = {
                "title": "更新后的QA Cell",
                "content": {"question": "这是一个测试问题", "answer": "", "isAIAnswer": False},
            }
        ...
        print(f"\n4. 测试QA问答功能...")
        try:
            qa_data = {"question": "什么是Python？", "ask_ai": True}
            response = await client.post(
        ...
        print(f"\n6. 测试Cell执行...")
        try:
            execution_data = {"cell_id": cell_id, "parameters": {}}
            response = await client.post(
