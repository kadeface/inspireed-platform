...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('pending', 'active', 'paused', 'ended', name='classsessionstatus'), nullable=False),
    ...
    # 创建 student_session_participations 表
    op.create_table(
    ...
    # 在 activity_submissions 表中添加 session_id 字段
